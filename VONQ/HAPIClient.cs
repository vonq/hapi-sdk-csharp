// <copyright file="HAPIClient.cs" company="APIMatic">
...
namespace VONQ
{
    ...
    /// </summary>
    public sealed class HAPIClient : IConfiguration
    {
            ...
            IHttpClientConfiguration httpClientConfiguration)
        {
            ...
            this.portfolio = new Lazy<PortfolioController>(
                () => new PortfolioController(this, this.httpClient, this.authManagers, this.httpCallBack));
            ...
            this.campaigns = new Lazy<CampaignsController>(
                () => new CampaignsController(this, this.httpClient, this.authManagers, this.httpCallBack));
            this.taxonomy = new Lazy<TaxonomyController>(
                () => new TaxonomyController(this, this.httpClient, this.authManagers, this.httpCallBack));
        }

        /// <summary>
        /// Gets PortfolioController controller.
        /// </summary>
        public PortfolioController PortfolioController => this.portfolio.Value;
        ...
        /// <summary>
        /// Gets TaxonomyController controller.
        /// </summary>
        public TaxonomyController TaxonomyController => this.taxonomy.Value;
        ...
        /// <summary>
        /// Creates an object of the HAPIClient using the values provided for the builder.
        /// </summary>
        ...
        /// </summary>
        /// <returns> HAPIClient.</returns>
        internal static HAPIClient CreateFromEnvironment()
        {
            var builder = new Builder();

            string environment = System.Environment.GetEnvironmentVariable("VONQ_ENVIRONMENT");
        ...
        {
            private Environment environment = VONQ.Environment.Sandbox;
