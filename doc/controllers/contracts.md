...
| `body` | [`Models.PostContractModel`](../../doc/models/post-contract-model.md) | Body, Required | - |

## Response Type

[`Task<Models.CreateContractResponseModel>`](../../doc/models/create-contract-response-model.md)

## Example Usage

```csharp
string xCustomerId = "X-Customer-Id2";
var body = new PostContract();
body.ChannelId = 30.52;
body.Credentials = ApiHelper.JsonDeserialize<Object>("{\"key1\":\"val1\",\"key2\":\"val2\"}");

try
{
    CreateContractResponseModel result = await contractsController.CreateContractAsync(xCustomerId, body);
}
...
```csharp
string contractId = "contract_id8";
string xCustomerId = "X-Customer-Id2";

try
{
    await contractsController.DeleteContractAsync(contractId, xCustomerId);
}
catch (ApiException e){};
```
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `channelId` | `double` | Template, Required | channel_id (number, required) |
| `postingRequirementName` | `string` | Template, Required | - |
| `body` | [`Models.FacetAutocompleteModel`](../../doc/models/facet-autocomplete-model.md) | Body, Required | - |

## Response Type

[`Task<List<Models.AutocompleteValuesResponseModel>>`](../../doc/models/autocomplete-values-response-model.md)

## Example Usage

```csharp
double channelId = 105.24;
string postingRequirementName = "posting-requirement-name2";
var body = new FacetAutocomplete();

try
{
    List<AutocompleteValuesResponseModel> result = await contractsController.ListAutocompleteValuesAsync(channelId, postingRequirementName, body);
}
catch (ApiException e){};
```
...
| `acceptLanguage` | [`Models.AcceptLanguageEnum?`](../../doc/models/accept-language-enum.md) | Header, Optional | The language the client prefers. |

## Response Type

[`Task<Models.ListChannelsResponseModel>`](../../doc/models/list-channels-response-model.md)
...
try
{
    ListChannelsResponseModel result = await contractsController.ListChannelsAsync(null, null, null, acceptLanguage);
}
catch (ApiException e){};
```
...
|  --- | --- | --- | --- |
| `xCustomerId` | `string` | Header, Required | An identifier for the remote customer |
| `limit` | `double?` | Query, Optional | Amount of contracts returned |
| `offset` | `double?` | Query, Optional | Starting point |

## Response Type

[`Task<Models.ListContractsResponseModel>`](../../doc/models/list-contracts-response-model.md)
...
try
{
    ListContractsResponseModel result = await contractsController.ListContractsAsync(xCustomerId, null, null);
}
catch (ApiException e){};
```
...
[`Task<Models.ChannelModel>`](../../doc/models/channel-model.md)
...
try
{
    ChannelModel result = await contractsController.RetrieveChannelAsync(channelId, acceptLanguage);
}
catch (ApiException e){};
```
...
[`Task<Models.ContractModel>`](../../doc/models/contract-model.md)
...
try
{
    ContractModel result = await contractsController.RetrieveContractAsync(contractId, xCustomerId);
}
catch (ApiException e){};
```
...
```csharp
RetrieveMultipleContractsAsync(
...
| Parameter | Type | Tags | Description |
|  --- | --- | --- | --- |
| `contractsIds` | `List<string>` | Template, Required | - |
| `limit` | `double?` | Query, Optional | Amount of contracts returned |
| `offset` | `double?` | Query, Optional | Starting point |

## Response Type

[`Task<Models.MultipleContractsResponseModel>`](../../doc/models/multiple-contracts-response-model.md)

## Example Usage

```csharp
var contractsIds = new List<string>();
contractsIds.Add("contracts_ids7");
contractsIds.Add("contracts_ids8");

try
{
    MultipleContractsResponseModel result = await contractsController.RetrieveMultipleContractsAsync(contractsIds, null, null);
}
catch (ApiException e){};
```
