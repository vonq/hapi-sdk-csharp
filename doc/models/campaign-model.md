...
| `OrderedProductsSpecs` | [`List<Models.OrderedProductsGetElementModel>`](../../doc/models/ordered-products-get-element-model.md) | Optional | This part contains information of the ordered products. |
| `Postings` | [`List<Models.CampaignPostingModel>`](../../doc/models/campaign-posting-model.md) | Optional | - |
